...
The Data Ingestor Service is responsible for receiving data from the VDR and storing it in a database. The Data Dashboard Service is responsible for providing access to the data through a dashboard. The Data Disgestor Service is responsible for processing the data and making it available for further analysis, storage or disposal through a API so other services can access it.