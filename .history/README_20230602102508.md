...
Ships often have dedicated devices known as VDR, "Voyage Data Recorders" or "Vessel Data Recorders" that collect and store various data readings. These recorders are specifically designed to capture and record critical data related to the vessel's navigation, operation, and safety.
