...
The Data Ingestor Service is responsible for receiving data from the VDR and storing it in a database. The service is composed of a REST API that receives data from the VDR and stores it in a database. The service also provides a REST API to access the data stored in the database.