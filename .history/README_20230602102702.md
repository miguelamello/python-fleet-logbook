...
However, VDRs can also streamming data in real time to a remote server. This is the case of this project. The VDRs will be sending data in real time to the Data Ingestor Service.
